  ...
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" style={{enableBackground: 'new 0 0 500 500'}} xmlSpace="preserve" {...props}>
      ...
      <g id="Layer_1_1_" className="st0">
        ...
        <path id="XMLID_10_" className="st1" d="M309.3,173.7c-5.6,0.2-11.2,0.6-16.7,1.7c-4.4,0.8-8.8,2-13,3.2c-1.9,0.5-3.9,1.1-5.8,1.7
        ...
        <path id="XMLID_1_" className="st1" d="M110.2,291.2c-2.6,0.5-5.2,1.2-7.7,2c-2.2,0.7-4.2,2-6.3,3c-1.7,0.9-3,2.5-4.3,3.8
      ...
      <g id="Layer_4">
        <g id="XMLID_23_">
          <path id="XMLID_25_" className="st2" d="M277,192.3c-3.6,1.6-7.3,3-10.9,4.7c-2.4,1.2-4.7,2.3-7.1,3.5c-0.4,0.2-0.8,0.4-1.2,0.6
        ...
        <g id="XMLID_24_">
          <linearGradient id="XMLID_3_" gradientUnits="userSpaceOnUse" x1="95.5695" y1="246.5213" x2="364.8047" y2="246.5213" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FFA954'}} />
            <stop offset="0.5468" style={{stopColor: '#FF7174'}} />
            <stop offset={1} style={{stopColor: '#B60055'}} />
          </linearGradient>
          <path id="XMLID_49_" className="st3" d="M362.2,177.1c-1.4-3-3.4-5.8-6-8.5c-6.9-7.1-16.5-11.2-26.3-13.1c-12.4-2.4-25.9-2.6-38.3-0.3
        ...
        <linearGradient id="XMLID_4_" gradientUnits="userSpaceOnUse" x1="201.1653" y1="261.8264" x2="317.1531" y2="328.7919" gradientTransform="matrix(1 0 0 -1 0 500)">
          <stop offset={0} style={{stopColor: '#FFA954'}} />
          <stop offset="0.5468" style={{stopColor: '#FF7174'}} />
          <stop offset="0.5969" style={{stopColor: '#FB6D72'}} />
          <stop offset="0.6506" style={{stopColor: '#EF606B'}} />
          <stop offset="0.706" style={{stopColor: '#DA4A60'}} />
          <stop offset="0.7626" style={{stopColor: '#BE2C50'}} />
          <stop offset="0.8196" style={{stopColor: '#9A063C'}} />
          <stop offset="0.8276" style={{stopColor: '#940039'}} />
        </linearGradient>
        <path id="XMLID_35_" className="st4" d="M277,192.3c6-2.6,12.2-4.6,18.5-6.5" />
      </g>
      <g id="Layer_8">
        <linearGradient id="XMLID_5_" gradientUnits="userSpaceOnUse" x1="113.1255" y1="189.0111" x2="131.0867" y2="157.9014" gradientTransform="matrix(1 0 0 -1 0 500)">
          <stop offset={0} style={{stopColor: '#FF003F', stopOpacity: '0.2'}} />
          <stop offset="0.1856" style={{stopColor: '#FF053F', stopOpacity: '0.1629'}} />
          <stop offset="0.4151" style={{stopColor: '#FF143F', stopOpacity: '0.117'}} />
          <stop offset="0.6675" style={{stopColor: '#FF2E3F', stopOpacity: '6.649384e-002'}} />
          <stop offset="0.9348" style={{stopColor: '#FF503F', stopOpacity: '1.303451e-002'}} />
          <stop offset={1} style={{stopColor: '#FF5A3F', stopOpacity: 0}} />
        </linearGradient>
        <path id="XMLID_38_" className="st5" d="M130.6,300.9c-11.3,16.3-21.7,32.9-29,51.2c0.6,0.2,1.2,0.4,1.8,0.5c15.9,3.7,26-15.1,33.3-26
        		c3.8-5.5,7.3-11.2,11-16.8C141.9,307,136.2,304.1,130.6,300.9z M117.6,345.9L117.6,345.9L117.6,345.9z" />
        <linearGradient id="XMLID_6_" gradientUnits="userSpaceOnUse" x1="117.9171" y1="206.3696" x2="351.719" y2="341.3551" gradientTransform="matrix(1 0 0 -1 0 500)">
          <stop offset={0} style={{stopColor: '#FFA954'}} />
          <stop offset="0.5468" style={{stopColor: '#FF7174'}} />
          <stop offset={1} style={{stopColor: '#B60055'}} />
        </linearGradient>
        <polygon id="XMLID_39_" className="st6" points="173.7,264.9 180.5,257 169.8,260.2 	" />
        <g id="XMLID_9_">
          <linearGradient id="XMLID_8_" gradientUnits="userSpaceOnUse" x1="183.1119" y1="228.7576" x2="233.1784" y2="315.4754" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#A3124E', stopOpacity: '0.3'}} />
            <stop offset="0.1832" style={{stopColor: '#A8164D', stopOpacity: '0.245'}} />
            <stop offset="0.4097" style={{stopColor: '#B7224B', stopOpacity: '0.1771'}} />
            <stop offset="0.6589" style={{stopColor: '#D13647', stopOpacity: '0.1023'}} />
            <stop offset="0.9227" style={{stopColor: '#F35141', stopOpacity: '2.319068e-002'}} />
            <stop offset={1} style={{stopColor: '#FF5A3F', stopOpacity: 0}} />
          </linearGradient>
          <path id="XMLID_41_" className="st7" d="M242.2,192.3c-7.5,3.7-46.8,24.3-75.9,61l-0.3,0.4c2.3,1.8,4.6,3.7,6.8,5.6l7.7-2.3
          			c4.3-4,8.7-8.1,13.3-11.8c15.8-13,32-25.2,49.5-35.8c1.4-0.9,2.8-1.7,4.2-2.5C246,201.9,244.1,197.1,242.2,192.3z" />
        </g>
        <g id="XMLID_7_">
          <linearGradient id="XMLID_31_" gradientUnits="userSpaceOnUse" x1="181.4612" y1="199.6496" x2="370.4734" y2="308.7759" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FFA954'}} />
            <stop offset="0.5468" style={{stopColor: '#FF7174'}} />
            <stop offset={1} style={{stopColor: '#B60055'}} />
          </linearGradient>
          <path id="XMLID_43_" className="st8" d="M190.3,293.3c12.3-4.8,25.5-7.4,38.2-11c26.9-7.6,53.7-16.3,78.8-28.7
          ...
          <linearGradient id="XMLID_36_" gradientUnits="userSpaceOnUse" x1="172.658" y1="194.5671" x2="347.4098" y2="295.46" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#A3124E', stopOpacity: '0.3'}} />
            <stop offset="0.1832" style={{stopColor: '#A8164D', stopOpacity: '0.245'}} />
            <stop offset="0.4097" style={{stopColor: '#B7224B', stopOpacity: '0.1771'}} />
            <stop offset="0.6589" style={{stopColor: '#D13647', stopOpacity: '0.1023'}} />
          ...
          <path id="XMLID_42_" className="st9" d="M190.3,293.3c12.3-4.8,25.5-7.4,38.2-11c26.9-7.6,53.7-16.3,78.8-28.7
          			c15.4-7.6,30.8-17.3,41.9-30.1L334,205c-52.6,51.6-158.5,72.6-158.9,72.6c1,6.7,2.5,13.3,4.6,19.7
          			C183.3,296,186.9,294.6,190.3,293.3z" />
        </g>
        <g id="XMLID_32_">
          <linearGradient id="XMLID_37_" gradientUnits="userSpaceOnUse" x1="170.0887" y1="219.4427" x2="359.1009" y2="328.5689" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FFA954'}} />
            <stop offset="0.5468" style={{stopColor: '#FF7174'}} />
            <stop offset={1} style={{stopColor: '#B60055'}} />
          </linearGradient>
          <path id="XMLID_34_" className="st10" d="M362.2,177.1c-1.4-3-3.4-5.8-6-8.5c-6.9-7.1-16.5-11.2-26.3-13.1c-6.6-1.3-13.5-1.9-20.3-1.9
          ...
          <linearGradient id="XMLID_44_" gradientUnits="userSpaceOnUse" x1="145.7993" y1="261.5133" x2="334.8116" y2="370.6395" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FFA954'}} />
            <stop offset="0.5468" style={{stopColor: '#FF7174'}} />
            <stop offset={1} style={{stopColor: '#B60055'}} />
          </linearGradient>
          <path id="XMLID_50_" className="st11" d="M287.3,156l4.3-0.9C290.2,155.4,288.8,155.7,287.3,156z" />
          <linearGradient id="XMLID_45_" gradientUnits="userSpaceOnUse" x1="142.5307" y1="267.1747" x2="331.543" y2="376.301" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FFA954'}} />
            <stop offset="0.5468" style={{stopColor: '#FF7174'}} />
            <stop offset={1} style={{stopColor: '#B60055'}} />
          </linearGradient>
          <path id="XMLID_51_" className="st12" d="M247.2,171c3.7-1.3,7.1-2.3,10.2-3.1l-1.8-1C252.7,168.3,250,169.6,247.2,171z" />
          <linearGradient id="XMLID_47_" gradientUnits="userSpaceOnUse" x1="256.6104" y1="320.2737" x2="325.9721" y2="360.3197" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FFA954'}} />
            <stop offset="0.5468" style={{stopColor: '#FF7174'}} />
            <stop offset={1} style={{stopColor: '#B60055'}} />
          </linearGradient>
          <path id="XMLID_54_" className="st13" d="M291.7,155.1c5.8-1.1,11.9-1.6,17.9-1.6C299.7,153.3,291.7,155.1,291.7,155.1z" />
          <linearGradient id="XMLID_48_" gradientUnits="userSpaceOnUse" x1="157.2754" y1="241.6361" x2="346.2877" y2="350.7623" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FFA954'}} />
            <stop offset="0.5468" style={{stopColor: '#FF7174'}} />
            <stop offset={1} style={{stopColor: '#B60055'}} />
          </linearGradient>
          <path id="XMLID_56_" className="st14" d="M309.6,153.5c-6.1,0-12.1,0.5-17.9,1.6l-4.3,0.9c-2.9,0.7-5.9,1.5-8.7,2.3
      ...
      <g id="Layer_15">
        <linearGradient id="XMLID_52_" gradientUnits="userSpaceOnUse" x1="130.8181" y1="185.3733" x2="112.2548" y2="178.6169" gradientTransform="matrix(1 0 0 -1 0 500)">
          <stop offset={0} style={{stopColor: '#000000', stopOpacity: '0.5'}} />
          <stop offset="0.5271" style={{stopColor: '#000000', stopOpacity: 0}} />
        </linearGradient>
        <polyline id="XMLID_26_" className="st15" points="117.6,293.4 134.9,329.9 125.5,342.6 107.9,309.3 117.6,293.4 	" />
      </g>
      <g id="Layer_13">
        <linearGradient id="XMLID_53_" gradientUnits="userSpaceOnUse" x1="296.65" y1="206.7606" x2="296.65" y2="151.4951" gradientTransform="matrix(1 0 0 1 0 2)">
          <stop offset="0.45" style={{stopColor: '#FFFFFF', stopOpacity: 0}} />
          <stop offset={1} style={{stopColor: '#FFFFFF', stopOpacity: '0.6'}} />
        </linearGradient>
        <path id="XMLID_27_" className="st16" d="M334,205c0,0,12-5.7,12-21.2c0-25-20.5-30.1-36.4-30.3c-6.1,0-12.1,0.5-17.9,1.6l-4.3,0.9
      ...
      <g id="Layer_11">
        <linearGradient id="XMLID_55_" gradientUnits="userSpaceOnUse" x1="190.9186" y1="266.4" x2="190.9186" y2="432.3741" gradientTransform="matrix(1 0 0 -1 0 500)">
          <stop offset={0} style={{stopColor: '#FFA954'}} />
          <stop offset="0.4975" style={{stopColor: '#FF7174'}} />
          <stop offset="0.6518" style={{stopColor: '#E24468'}} />
          <stop offset="0.802" style={{stopColor: '#CA1F5E'}} />
          <stop offset="0.9132" style={{stopColor: '#BB0858'}} />
          <stop offset={1} style={{stopColor: '#8A0040'}} />
        </linearGradient>
        <path id="XMLID_14_" className="st17" d="M188.4,68c-27.5-4-25.3,25.4-25.3,25.4c0-1.3,0.3-1.7,0.6-1.6c0.5,0.2,1.3,1.7,1.5,2.6
        ...
        <g id="XMLID_40_">
          <linearGradient id="XMLID_57_" gradientUnits="userSpaceOnUse" x1="138.3528" y1="326.684" x2="232.2027" y2="380.8682" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#70001B', stopOpacity: '0.25'}} />
            <stop offset="3.588855e-002" style={{stopColor: '#70001B', stopOpacity: '0.241'}} />
            <stop offset={1} style={{stopColor: '#70001B', stopOpacity: 0}} />
          </linearGradient>
          <path id="XMLID_46_" className="st18" d="M174.8,229.8c3.2-6.8,6.2-13.6,9.1-20.5c3.9-9.2,7.5-18.6,10.9-27.9
      ...
      <g id="Layer_2">
        <g id="XMLID_17_">
          <path id="XMLID_21_" className="st2" d="M163,132.2c0.4,20.7,1.5,41.4,3.6,62c3.8-16,5.1-33.2,5.2-49.6c0.1-9.7-0.5-19.4-2-28.9
          			c-0.7-4.8-1.6-9.5-2.8-14.2c-0.5-2.2-1.1-4.3-1.7-6.5l-2.3-1.5C162.9,106.3,162.8,119.3,163,132.2z" />
          <path id="XMLID_20_" className="st19" d="M212.4,126.2c0.5-1.5,0.9-3,1.2-4.5C213.2,123.2,212.8,124.7,212.4,126.2L212.4,126.2z" />
        </g>
        <g id="XMLID_13_">
          <linearGradient id="XMLID_58_" gradientUnits="userSpaceOnUse" x1="164.0842" y1="39.2022" x2="164.0842" y2="469.4235" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FFA954'}} />
            <stop offset="0.4975" style={{stopColor: '#FF7174'}} />
            <stop offset={1} style={{stopColor: '#B60055'}} />
          </linearGradient>
          <path id="XMLID_16_" className="st20" d="M245.8,444.7c-0.5-7.8-6.4-16.6-9.7-23.5c-6.7-13.8-13.5-27.4-19.9-41.3
      ...
      <g id="Layer_9">
        <g id="XMLID_12_">
          <linearGradient id="XMLID_59_" gradientUnits="userSpaceOnUse" x1="135.904" y1="468.804" x2="135.904" y2="237.3609" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#70001B', stopOpacity: '0.25'}} />
            <stop offset={1} style={{stopColor: '#70001B', stopOpacity: 0}} />
          </linearGradient>
          <path id="XMLID_61_" className="st21" d="M120.1,147.9c-1-18.2-4-36.3-3.6-54.6c0.3-16.4,4-34.5,15.8-46.8
          ...
          <linearGradient id="XMLID_60_" gradientUnits="userSpaceOnUse" x1="179.3" y1="39.0991" x2="179.3" y2="218.4" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FF003F', stopOpacity: '0.2'}} />
            <stop offset="0.1856" style={{stopColor: '#FF053F', stopOpacity: '0.1629'}} />
            <stop offset="0.4151" style={{stopColor: '#FF143F', stopOpacity: '0.117'}} />
            <stop offset="0.6675" style={{stopColor: '#FF2E3F', stopOpacity: '6.649384e-002'}} />
          ...
          <path id="XMLID_63_" className="st22" d="M240,454.1c-27.9-22.8-47.5-54.1-62.7-86.4c-13.1-27.8-24.2-56.6-33.1-86.1
          ...
          <path id="XMLID_67_" className="st23" d="M196.6,35.8c-2.2-1-4.4-1.8-6.5-2.3C192.3,34.2,194.5,34.9,196.6,35.8L196.6,35.8z" />
        </g>
        ...
        <path id="XMLID_22_" className="st24" d="M142,17.5" />
      </g>
      <g id="Layer_12">
        <linearGradient id="XMLID_64_" gradientUnits="userSpaceOnUse" x1="168.873" y1="211.1346" x2="138.7841" y2="168.1632" gradientTransform="matrix(1 0 0 -1 0 500)">
          <stop offset={0} style={{stopColor: '#000000', stopOpacity: '0.6'}} />
          <stop offset="0.6355" style={{stopColor: '#000000', stopOpacity: 0}} />
        </linearGradient>
        <path id="XMLID_30_" className="st25" d="M105.6,257.4l12.1,3.7l72.4,47c0,0,11.7,39.5,16.3,49l-77.2-32c0,0-5.4-13.8-7.4-18.7
        		c-1.9-4.9-9.2-26-9.2-26L105.6,257.4z" />
      </g>
      <g id="Layer_5">
        <g id="XMLID_18_">
          <linearGradient id="XMLID_65_" gradientUnits="userSpaceOnUse" x1="119.6304" y1="209.1757" x2="103.668" y2="225.1381" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FFDA54'}} />
            <stop offset="0.2565" style={{stopColor: '#FDD751'}} />
            <stop offset="0.4585" style={{stopColor: '#F7CD48'}} />
            <stop offset="0.6418" style={{stopColor: '#EDBC38'}} />
            <stop offset="0.8141" style={{stopColor: '#DEA521'}} />
            <stop offset="0.9773" style={{stopColor: '#CC8705'}} />
            <stop offset={1} style={{stopColor: '#C98200'}} />
          </linearGradient>
          <path id="XMLID_29_" className="st26" d="M117.1,293.3c-2.2-7-6.8-20.3-6.8-20.3C86.9,276.9,117.1,293.3,117.1,293.3z" />
          <linearGradient id="XMLID_66_" gradientUnits="userSpaceOnUse" x1="134.6635" y1="154.6295" x2="400.9362" y2="308.3622" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FFDA54'}} />
            <stop offset="0.1526" style={{stopColor: '#FFB061'}} />
            <stop offset="0.3051" style={{stopColor: '#FF8E6C'}} />
            <stop offset="0.4303" style={{stopColor: '#FF7972'}} />
            <stop offset="0.5123" style={{stopColor: '#FF7174'}} />
            <stop offset={1} style={{stopColor: '#B60055'}} />
          </linearGradient>
          <path id="XMLID_19_" className="st27" d="M433,259.3c-21-7.4-40.9-0.7-60.2,8.7c-36.8,18-77.3,45.4-120.2,38
      ...
      <g id="Layer_7">
        <g id="XMLID_11_">
          <linearGradient id="XMLID_68_" gradientUnits="userSpaceOnUse" x1="307.9629" y1="153.5496" x2="377.2296" y2="273.5229" gradientTransform="matrix(1 0 0 -1 0 500)">
            <stop offset={0} style={{stopColor: '#FFFFFF', stopOpacity: 0}} />
            <stop offset={1} style={{stopColor: '#FFFFFF', stopOpacity: '0.4'}} />
          </linearGradient>
          <path id="XMLID_28_" className="st28" d="M278.7,323c35.7,2.7,45.7-5,103.3-36.3c54.5-29.6,64.2-15.5,65.2-13.8
      ...
      <g id="Layer_6">
        <linearGradient id="XMLID_69_" gradientUnits="userSpaceOnUse" x1="179.3903" y1="242.5327" x2="179.3903" y2={160} gradientTransform="matrix(1 0 0 -1 0 500)">
          <stop offset={0} style={{stopColor: '#FF003F', stopOpacity: '0.25'}} />
          <stop offset="0.2625" style={{stopColor: '#FF213F', stopOpacity: '0.1844'}} />
          <stop offset="0.5654" style={{stopColor: '#FF403F', stopOpacity: '0.1087'}} />
          <stop offset="0.8221" style={{stopColor: '#FF533F', stopOpacity: '4.447849e-002'}} />
          <stop offset={1} style={{stopColor: '#FF5A3F', stopOpacity: 0}} />
        </linearGradient>
        <path id="XMLID_33_" className="st29" d="M149.4,268.8c-29.2-15.5-47.9-12.8-53.8-5.5c-7.6,9.4,6.7,21.3,7.4,22c4,3.3,8.5,5.7,14.2,8.1
