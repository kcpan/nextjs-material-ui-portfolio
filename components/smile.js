...
export default function Smile(props) {
  ...
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" style={style}  xmlSpace="preserve" width={500} height={500} {...props}>
      <style type="text/css"/>
      <g id="XMLID_4_">
        <g id="XMLID_3_">
      ...
      <linearGradient id="linear-gradient" gradientUnits="userSpaceOnUse" gradientTransform="rotate(-45)">
